...
class StatisticalAnalyzerTester:
    ...
    def test_cohens_d_calculation(
        self, current_scores: List[float], baseline_scores: List[float]
    ) -> Dict[str, Any]:
        """
        Cohen's d効果サイズ計算テスト
    ...
    def test_p_value_calculation(
        ...
        result = {
            ...
            "input_data": {
                "current_scores": current_scores,
                "baseline_scores": baseline_scores,
                "sample_sizes": {"current": len(current_scores), "baseline": len(baseline_scores)},
            },
            "calculation_result": {
                ...
                "confidence_intervals": {
                    ...
                    "baseline": {
                        "lower": round(baseline_ci[0], 3),
                        "upper": round(baseline_ci[1], 3),
                    },
                },
            },
            "interpretation": {
    ...
    def test_complete_statistical_analysis(
        self, tracker_id: str, baseline_tracker_id: str
    ) -> Dict[str, Any]:
        """
        完全統計分析テスト
        ...
        complete_result = {
            ...
            "trackers": {"current": tracker_id, "baseline": baseline_tracker_id},
    ...
    def test_google_sheets_integration(self, tracker_id: str) -> Dict[str, Any]:
        ...
        result = {
            ...
            "operations": {
                ...
                "statistical_update": {"success": update_success, "data_updated": update_success},
                "status_update": {
    ...
    def test_statistical_workflow_end_to_end(self, tracker_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            workflow_results["workflow_summary"] = {
                "overall_success": all(
                    [
                        workflow_results["step1_data_retrieval"]["integration_summary"][
            ...
            workflow_results["error"] = {"message": str(e), "step": "統計ワークフロー実行中"}
            workflow_results["workflow_summary"] = {
...
def main():
    ...
    if len(sys.argv) < 3:
        print(
            "Usage: python statistical_analyzer_tester.py <test_type> <tracker_id> [baseline_tracker_id] [output_dir]"
        )
