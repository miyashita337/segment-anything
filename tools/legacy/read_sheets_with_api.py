...
class SheetsReader:
    ...
    def __init__(self):
        ...
        try:
            ...
            print(f"📊 スプレッドシートURL: https://docs.google.com/spreadsheets/d/{self.updater.spreadsheet_id}/edit")
    ...
    def display_table(self, data: List[List[str]], title: str = "Google Sheetsデータ", limit: Optional[int] = None) -> None:
        """テーブル形式で表示"""
        if not data:
            print("📝 表示するデータがありません")
            return
    ...
    def display_task_detail(self, task_data: List[str]) -> None:
        ...
        headers = [
            "トラッカーID", "優先度", "ステータス", "登録日付", "更新日付", "概要",
