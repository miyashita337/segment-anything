...
class ToolsManager:
    ...
    def sheets_list(self, priority: Optional[str] = None, 
    ...
    def sheets_update(self, tracker_id: str, status: Optional[str] = None,
    ...
    def validate_placement(self, file_path: str) -> Dict[str, Any]:
        ...
        elif filename.endswith('_release.py') or filename.startswith('p1_') or filename.startswith('tdr_'):
