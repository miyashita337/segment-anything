...
class QCC023EnhancedCohensD:
    ...
    def calculate_enhanced_cohens_d(
        ...
        # 6. サンプルサイズ妥当性評価
        sample_size_adequacy = self._evaluate_sample_size_adequacy(cohens_d, n_current, n_baseline)
...
"""
    ...
    def run_qcc023_enhanced_analysis(
        self, current_tracker: str, baseline_tracker: str = "PH2-006"
    ) -> Dict:
        ...
        try:
            ...
            analysis_result = {
                ...
                "sample_sizes": {"current": len(current_data), "baseline": len(baseline_data)},
                "descriptive_stats": {
                    "current": {
            ...
            print(
                f"   95%信頼区間: [{enhanced_result.confidence_interval[0]:.4f}, {enhanced_result.confidence_interval[1]:.4f}]"
            )
