        ...
        try:
            ...
            if result.returncode == 0:
                ...
                if extraction_dir.exists():
                    ...
                    # 成功率計算
                    success_rate = (len(output_files) / len(image_files)) * 100 if len(image_files) > 0 else 0
...
def main():
    ...
    print("   /mnt/c/AItools/lora/train/yado/tracker-workspace/P1-013/background_extraction_log.txt")
    print("")
