...
def calculate_p1_a001_metrics() -> MetricsRecord:
    ...
    report_path = Path("/mnt/c/AItools/lora/train/yado/clipped_boundingbox/workspace/P1-A001/ENHANCED-MERGE/enhanced_extraction_report.json")
...
def main():
    ...
    output_path = Path("/mnt/c/AItools/lora/train/yado/clipped_boundingbox/workspace/P1-A001/metrics_p1_a001.json")
