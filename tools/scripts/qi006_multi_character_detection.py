    ...
    try:
        ...
        for i, image_path in enumerate(image_files):
            try:
                ...
                stats['character_counts'][char_count] = stats['character_counts'].get(char_count, 0) + 1
        ...
        print(f"   成功率: {stats['success_rate']:.1f}% ({stats['successful_detections']}/{stats['total_images']})")
        print(f"   複数キャラ率: {stats['multiple_character_rate']:.1f}% ({stats['multiple_character']}/{stats['total_images']})")
