...
def create_english_radar_chart(output_path: Path):
    ...
    # サンプルデータ（PH2-002相当）
    metrics_names = ["Character Acc", "A/B Rate", "FPS", "C+ Rate", "SCI", "PLA", "PLE"]
...
def main():
    output_path = Path(
        "/mnt/c/AItools/lora/train/yado/clipped_boundingbox/workspace/PH2-002/dashboard/radar_chart.png"
    )
