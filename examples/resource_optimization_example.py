...
def example_basic_resource_management():
    ...
    # リソースマネージャー作成
    manager = ResourceManager(memory_threshold_mb=500, auto_cleanup=True)
...
def example_batch_processing():
    ...
    batch_processor = BatchProcessor(
        initial_batch_size=16, min_batch_size=1, max_batch_size=64, memory_fraction=0.7
    )
...
def example_resource_monitoring():
    ...
    manager = ResourceManager(memory_threshold_mb=300, monitoring_interval=2.0, auto_cleanup=True)
...
def example_gpu_resource_management():
    ...
    manager = ResourceManager(gpu_memory_threshold_mb=1000, auto_cleanup=True)
