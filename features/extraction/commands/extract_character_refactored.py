...
@click.option(
    "--max-files", type=int, help="P1-018: Maximum number of files to process in batch mode"
)
...
@click.option(
    "--backup-retention-days", type=int, default=7, help="PH2-007: Backup retention period in days"
)
@click.option(
    "--enable-quality-monitoring",
    is_flag=True,
    default=True,
    help="P1-B001: Enable integrated quality monitoring",
)
@click.option(
    "--quality-threshold",
    type=float,
    default=0.7,
    help="P1-B001: Quality threshold for success detection",
)
