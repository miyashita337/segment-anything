...
class PerformanceMonitor:
    ...
    def get_bottleneck_analysis(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            stage_averages = {
                stage: stage_totals[stage] / stage_counts[stage] for stage in stage_totals
            }
    ...
    def create_processing_session(self, image_path: str) -> str:
        ...
        try:
            ...
            session = ProcessingSession(
                ...
                image_characteristics=self.parameter_optimizer._analyze_image_characteristics(
                    image
                ),
        ...
        try:
            ...
            if quality_score > 0:
                self.parameter_optimizer.learn_from_quality_feedback(
                    session.image_characteristics, quality_score, session.optimization_parameters
                )
                ...
                recommendations.append(
                    {
                        ...
                        "actions": ["高速処理パラメータパターンの自動適用", "画像特性に基づく事前最適化", "処理時間予測の精度向上"],
                    }
                )
    ...
    if Path(test_image).exists():
        ...
        if session_id:
            ...
            system.complete_processing_session(
                session_id, start_metrics, success=True, actual_quality_score=2.5
            )
