...
def is_already_processed(input_file: str, output_dir: str, suffix: str) -> Optional[str]:
    ...
    if os.path.exists(expected_path) and os.path.getsize(expected_path) > 1000:  # Minimum size check
...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        ("extracted_kana08_0001_multi_char_detection.jpg", "multi_char_detection")  # Should not duplicate
    ]
