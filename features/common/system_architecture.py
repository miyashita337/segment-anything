...
class SystemArchitectureAnalyzer:
    ...
    def analyze_code_structure(self) -> Dict[str, Any]:
        ...
        structure = {
            ...
            "memory_management": {"files_with_gc": 0, "files_with_cuda_cache": 0},
        }
            ...
            try:
                with open(py_file, "r", encoding="utf-8") as f:
                    ...
                    if module_path not in structure["modules"]:
                        structure["modules"][module_path] = {"files": 0, "lines": 0}
    ...
    def analyze_performance_bottlenecks(self) -> List[Dict[str, Any]]:
        ...
        # 2. エラー処理の質
        error_ratio = self.analysis_results["code_structure"]["error_handling"][
            "generic_exceptions"
        ] / max(
            1,
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        self.analysis_results["summary"] = {
            ...
            "high_priority_items": sum(
                1
                for opt in self.analysis_results["optimization_points"]
    ...
    def save_report(self, output_path: str = None):
        ...
        print("\n💡 最優先最適化ポイント:")
        for opt in [
            o for o in self.analysis_results["optimization_points"] if o["priority"] == "high"
        ]:
