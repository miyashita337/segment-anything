...
class VisualVerificationSystem:
    ...
    def _verify_visual_match(self, image_id: str, ai_result: Dict, human_label: Dict) -> VerificationResult:
        """視覚的一致度検証"""
        # 境界ボックス抽出
    ...
    def _calculate_size_ratio(self, bbox1: Tuple[int, int, int, int], 
    ...
    def _classify_visual_issue(self, visual_match: bool, ai_result: Dict, 
                             human_label: Dict) -> Optional[str]:
        """視覚問題分類"""
        if visual_match:
            return None
