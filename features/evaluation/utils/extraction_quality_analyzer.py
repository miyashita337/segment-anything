...
class ExtractionQualityAnalyzer:
    ...
    def _analyze_edge_quality(
        self, gray: np.ndarray, issues: List[str], recommendations: List[str]
    ) -> tuple:
        """エッジ品質の分析"""
        # Canny エッジ検出
    ...
    def _analyze_brightness_quality(
        self, gray: np.ndarray, issues: List[str], recommendations: List[str]
    ) -> tuple:
        """明度品質の分析"""
