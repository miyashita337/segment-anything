...
class BlackScreenDetector:
    ...
    def _evaluate_black_screen(
        self, brightness: float, distribution: dict, dark_regions: dict
    ...
    def get_black_screen_statistics(self, results: list[BlackScreenDetectionResult]) -> dict:
        ...
        stats = {
            ...
            "black_screen_avg_brightness": np.mean(black_brightness_scores)
            if black_brightness_scores
            else 0.0,
            "threshold_used": self.brightness_threshold,
        }
