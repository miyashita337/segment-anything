...
def main():
    ...
    print("🔍 QCC-011 vs QI-006 統計分析開始")
    ...
    print(f"📈 Current(QCC-011): {qcc011_data['total_images']}枚、平均品質スコア: {qcc011_data['mean_quality_score']:.6f}")
    print(f"📈 Baseline(QI-006): {qi006_data['total_images']}枚、平均品質スコア: {qi006_data['mean_quality_score']:.6f}")
    
    # 統計分析実行
    stats_result = perform_statistical_analysis(qcc011_data, qi006_data)
    ...
    analysis_result = {
        ...
        'current_tracker': 'QCC-011',
        'baseline_tracker': 'QI-006',
        'current_metrics': {
    ...
    # JSON保存
    output_file = '/mnt/c/AItools/lora/train/yado/tracker-workspace/QCC-011/statistical_analysis_result.json'
    with open(output_file, 'w', encoding='utf-8') as f:
        json.dump(analysis_result, f, indent=2, ensure_ascii=False, default=str)
    
    print(f"📄 分析結果保存: {output_file}")
    print("✅ QCC-011 vs QI-006 統計分析完了")
