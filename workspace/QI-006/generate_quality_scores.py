...
def analyze_extraction_directory(extraction_dir):
    ...
    print(f"📊 QI-006品質解析開始: {len(image_files)}枚")
...
def main():
    ...
    extraction_dir = '/mnt/c/AItools/lora/train/yado/tracker-workspace/QI-006/extraction'
    output_file = '/mnt/c/AItools/lora/train/yado/tracker-workspace/QI-006/extraction_result.json'
    
    print("🔧 QI-006品質スコア生成システム起動")
