...
def extract_character_simple(
    image: np.ndarray, sam_wrapper: SAMModelWrapper, yolo_wrapper: YOLOModelWrapper
    ...
    try:
        ...
        masks, scores, _ = sam_wrapper.predict(image, box=box_prompt, multimask_output=True)
