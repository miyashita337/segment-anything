...
def analyze_extraction_directory(extraction_dir):
    ...
    print(f"📊 QCC-011品質解析開始: {len(image_files)}枚")
...
def main():
    ...
    extraction_dir = '/mnt/c/AItools/lora/train/yado/tracker-workspace/QCC-011/extraction'
    output_file = '/mnt/c/AItools/lora/train/yado/tracker-workspace/QCC-011/extraction_result.json'
    
    print("🔧 QCC-011品質スコア生成システム起動")
