...
def main():
    ...
    mode_group.add_argument(
        "--region", metavar="x,y,w,h", help="Bounding box region (format: x,y,width,height)"
    )
...
def extract_with_points(
    image_path: str, points_args: list, output_path: str = None, verbose: bool = True
) -> dict:
    """シードポイントでの抽出"""
...
def extract_with_region(
    image_path: str, region_arg: str, output_path: str = None, verbose: bool = True
) -> dict:
    """バウンディングボックスでの抽出"""
