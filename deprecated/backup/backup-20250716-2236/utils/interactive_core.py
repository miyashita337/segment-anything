...
# 便利関数
def quick_extract_with_points(
    image_path: str, points: List[Tuple[int, int, bool]], output_path: str = None
) -> Dict[str, Any]:
    """シードポイントでクイック抽出"""
...
def quick_extract_with_region(
    image_path: str, region: Tuple[int, int, int, int], output_path: str = None
) -> Dict[str, Any]:
    """バウンディングボックスでクイック抽出"""
    from hooks.start import get_sam_model, get_yolo_model
