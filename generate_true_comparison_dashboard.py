...
def create_comparison_chart():
    ...
    bars1 = ax1.bar(x - width/2, baseline_values, width, label='ベースライン (kana08, 26枚)', alpha=0.8, color='skyblue')
    bars2 = ax1.bar(x + width/2, phase1_values, width, label='Phase 1 (kana05, 10枚)', alpha=0.8, color='lightcoral')
