#!/usr/bin/env python3
"""
kaname08 最高品質キャラクター抽出バッチ実行 v2
v0.3.2 with RegionPrioritySystem - org/kaname08直下の画像処理
"""
...
def run_kaname08_extraction_v2():
    """kaname08バッチ抽出実行 v2 - org直下の画像"""
    
    # パス設定（org/kaname08直下）
    input_path = "/mnt/c/AItools/lora/train/yadokugaeru/org/kaname08"
    output_path = "/mnt/c/AItools/lora/train/yadokugaeru/clipped_boundingbox/kaname08"
    
    print("🚀 kaname08 最高品質キャラクター抽出バッチ実行開始 v2 (v0.3.2)")
    print(f"入力パス: {input_path}")
    print(f"出力パス: {output_path}")
    print("📝 注: org/kaname08直下の画像を処理します")
