...
class MockProgressManager:
    ...
    def get_overdue_tasks(self) -> List[ProgressTask]:
        ...
        for task in self.tasks.values():
            ...
            expected_completion = task.started_at + timedelta(hours=task.estimated_hours * 1.2)  # 20%のバッファ
    ...
    def get_progress_statistics(self) -> Dict[str, Any]:
        ...
        if active_tasks:
            ...
            stats["average_progress_percentage"] = sum(progress_percentages) / len(progress_percentages)
