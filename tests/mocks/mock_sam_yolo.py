...
class MockSamYoloExtractor:
    ...
    def extract_batch(self, input_dir: str, output_dir: str, max_files: Optional[int] = None) -> Dict[str, Any]:
        """
        バッチ抽出のモック
        ...
        if batch_results["successful_extractions"] > 0:
            batch_results["average_quality_score"] = total_quality / batch_results["successful_extractions"]
