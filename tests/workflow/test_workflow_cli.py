...
from tests.workflow.fixtures.mock_data import MockData, SAMPLE_TRACKER_ID, SAMPLE_SUMMARY, SAMPLE_DETAILS, SAMPLE_AUTHOR_NAME
...
class TestWorkflowCLI(WorkflowTestBase):
    ...
    def setup_all_command_mocks(self):
        ...
        self.add_mock('tools.workflow.workflow_cli.SubAgentCommandHandler',
        ...
        self.add_mock('tools.workflow.workflow_cli.ProgressManager',
    ...
    def test_main_plan_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'plan', SAMPLE_TRACKER_ID, SAMPLE_SUMMARY, SAMPLE_DETAILS, SAMPLE_AUTHOR_NAME
        ]
    ...
    def test_main_create_command(self, mock_argv):
        ...
        # createコマンドの引数を設定
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'create', SAMPLE_TRACKER_ID
        ]
    ...
    def test_main_status_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'status', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_instructions_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'instructions', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_step_command(self, mock_argv):
        """main関数 - stepコマンドテスト"""
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'step', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_process_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'process', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_sheets_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'sheets', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_template_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'template', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_subagent_extraction_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'subagent-extraction', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_subagent_status_command(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'subagent-status', SAMPLE_TRACKER_ID
        ]
        mock_argv.__len__.return_value = 3
    ...
    def test_main_invalid_command(self, mock_argv):
        """main関数 - 無効なコマンドテスト"""
        mock_argv.__getitem__.side_effect = [
            'workflow_cli.py', 'invalid-command'
        ]
        mock_argv.__len__.return_value = 2
    ...
    def test_main_keyboard_interrupt(self, mock_argv):
        ...
        self.add_mock('tools.workflow.workflow_cli.get_status',
    ...
    def test_command_function_mapping(self):
        ...
        for command, function_name in command_functions.items():
            with self.subTest(command=command, function=function_name):
                self.assertTrue(hasattr(workflow_cli, function_name),
    ...
    def test_virtual_environment_check(self):
        ...
        with patch('os.environ.get') as mock_env_get:
            mock_env_get.side_effect = lambda key, default=None: 'true' if key == 'GITHUB_ACTIONS' else default
        ...
        # 正常な仮想環境でのテスト
        with patch('os.environ.get') as mock_env_get:
            mock_env_get.side_effect = lambda key, default=None: '/path/to/sam-env' if key == 'VIRTUAL_ENV' else default
    ...
    def test_argument_parsing_plan_command(self):
        ...
        test_args = [
            'workflow_cli.py', 'plan', 'TEST-001', '概要テスト', '詳細テスト', 'test_author', '--priority', 'high'
        ]
    ...
    def test_argument_parsing_subagent_extraction(self):
        ...
        test_args = [
            'workflow_cli.py', 'subagent-extraction', 'TEST-001', '/custom/path', '--max-files', '50'
        ]
    ...
    def test_argument_parsing_subagent_wait(self):
        ...
        test_args = [
            'workflow_cli.py', 'subagent-wait', 'TEST-001', '--timeout', '30'
        ]
    ...
    def test_argument_parsing_subagent_terminate(self):
        ...
        test_args = [
            'workflow_cli.py', 'subagent-terminate', 'TEST-001', '--force'
        ]
    ...
    def test_help_text_generation(self):
        ...
        with patch('sys.argv', ['workflow_cli.py', '--help']), \
             patch('sys.exit') as mock_exit, \
             patch('argparse.ArgumentParser.print_help') as mock_help:
    ...
    def test_error_handling_in_command_execution(self):
        ...
        # planコマンドでエラーを発生させる
        self.add_mock('tools.workflow.workflow_cli.plan_tracker',
                     return_value=False)
