...
class MockData:
    ...
    # 標準的なトラッカーID
    VALID_TRACKER_IDS = ["TRACKER-001", "KIRO-006", "QUAL-044", "TEST-123", "INTG-088"]
    ...
    MOCK_WORKFLOW_STATUS = {
        "TRACKER-001": {
            ...
            "can_proceed": True,
            "completed_steps": [{"step_id": "planning", "completed_at": "2025-09-27 10:00:00"}],
            "pending_approvals": [],
            "blocked_actions": [],
    ...
    def get_mock_workflow_status(cls, tracker_id: str) -> Dict[str, Any]:
        ...
        return cls.MOCK_WORKFLOW_STATUS.get(
            tracker_id, {"error": "Tracker not found", "status": "not_found"}
        )
