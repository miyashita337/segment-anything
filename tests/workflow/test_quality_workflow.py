...
class TestQualityWorkflow:
    ...
    def test_mock_sam_yolo_quality_methods(self):
        ...
        for method in methods:
            ...
            # 許容範囲±15%で確認
            assert (
                abs(actual_success_rate - expected_rate) <= 0.15
            ), f"Method {method}: expected {expected_rate}, got {actual_success_rate}"
    ...
    def test_mock_sam_yolo_grade_distribution(self):
        ...
        if total_success > 0:
            ...
            for grade, expected_ratio in expected_distribution.items():
                ...
                assert (
                    abs(actual_ratio - expected_ratio) <= 0.15
                ), f"Grade {grade}: expected {expected_ratio}, got {actual_ratio}"
    ...
    def test_mock_sam_yolo_batch_extraction(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert (
                batch_result["successful_extractions"] + batch_result["failed_extractions"]
    ...
    def test_quality_evaluator_success_case(self):
        ...
        # 成功的な抽出結果のモック
        extraction_result = {"success": True, "quality_score": 0.85, "grade": "A"}
    ...
    def test_quality_evaluator_failure_case(self):
        ...
        # 失敗的な抽出結果のモック
        extraction_result = {"success": False, "error": "抽出失敗"}
    ...
    def test_quality_report_generation(self):
        ...
        batch_result = {
            ...
            "quality_distribution": {"A": 4, "B": 6, "C": 4, "D": 2, "F": 4},
        }
