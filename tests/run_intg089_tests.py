...
class INTG089TestRunner:
        ...
        for test_file in unit_test_files:
            ...
            try:
                ...
                result = subprocess.run(
                    [sys.executable, "-m", "pytest", test_file, "-v", "--tb=short", "--timeout=30"],
                    capture_output=True,
                    text=True,
                    timeout=60,
                )
    ...
    def run_integration_tests(self) -> Dict[str, Any]:
        ...
        return {"status": "skipped", "reason": "実装調整中"}
    ...
    def run_mock_tests(self) -> Dict[str, Any]:
        ...
        try:
            ...
            mock_results["deduplication_test"] = {"first_send": result2, "duplicate_send": result3}
