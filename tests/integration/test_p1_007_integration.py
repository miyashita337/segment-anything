...
class TestYOLOWrapperIntegration:
    ...
    def test_fallback_to_traditional_method(self):
        ...
        result = wrapper.select_best_mask_with_criteria(mock_masks, test_image, "balanced")
    ...
    @patch(
        "features.evaluation.utils.enhanced_aspect_ratio_analyzer.evaluate_enhanced_aspect_ratio"
    )
...
class TestP1007WithExistingSystems:
    ...
    def test_compatibility_with_p1_003_enhanced_fullbody(self):
        ...
        # Create test data
        test_image = np.random.randint(0, 255, (400, 200, 3), dtype=np.uint8)
        test_mask_data = {"bbox": [50, 50, 100, 300], "area": 30000}
...
class TestEndToEndProcessing:
    ...
    def test_multiple_character_styles_handling(self):
        ...
        for scenario in character_scenarios:
            ...
            mask_data = {"bbox": bbox, "area": bbox[2] * bbox[3], "yolo_confidence": 0.8}
    ...
    def test_performance_with_large_images(self):
        ...
        large_mask_data = {"bbox": [200, 100, 400, 1000], "area": 400000, "yolo_confidence": 0.9}
...
class TestRegressionPrevention:
    ...
    def test_all_existing_criteria_still_work(self):
        ...
        for criteria in existing_criteria:
            result = wrapper.select_best_mask_with_criteria(mock_masks, test_image, criteria)
    ...
    def test_p1_001_through_p1_006_still_importable(self):
        ...
        try:
            # P1-002
            from features.evaluation.utils.partial_extraction_detector import (
            ...
            # P1-004
            from features.evaluation.utils.enhanced_screentone_detector import (
    ...
    def test_no_performance_degradation(self):
        ...
        ), f"P1-007 performance ratio: {performance_ratio:.1f}x (should be < 50x)"
