...
class TestP1B004AdaptiveCropping(unittest.TestCase):
    ...
    def test_contamination_reduction_calculation(self):
        ...
        reduction_min = (
            (original_contamination - optimized_contamination_max) / original_contamination * 100
        )
        reduction_max = (
            (original_contamination - optimized_contamination_min) / original_contamination * 100
        )
