...
class TestScreentoneFeatureExtractor(unittest.TestCase):
    ...
    def _create_dot_pattern(
        self, height: int, width: int, dot_size: int, spacing: int
    ) -> np.ndarray:
        """ドットパターン画像の生成"""
    ...
    def _create_line_pattern(
        self, height: int, width: int, line_width: int, spacing: int
    ) -> np.ndarray:
        """線パターン画像の生成"""
        image = np.ones((height, width), dtype=np.uint8) * 255
    ...
    def test_extractor_initialization(self):
        ...
        print(
            f"Feature extractor initialized with {len(extractor.gabor_params['frequencies'])} frequencies, "
    ...
    def test_fft_feature_extraction(self):
        ...
        print(
            f"FFT features extracted: periodicity={dot_features['periodicity_score']:.3f}, "
    ...
    def test_gabor_feature_extraction(self):
        ...
        self.assertGreater(
            line_features["gabor_max_response"], line_features["gabor_mean_response"]
        )

        print(
            f"Gabor features extracted: max_response={line_features['gabor_max_response']:.1f}, "
    ...
    def test_lbp_feature_extraction(self):
        ...
        # 必要な特徴量が含まれていることを確認
        required_features = ["lbp_entropy", "uniform_ratio", "texture_complexity"]
        ...
        print(
            f"LBP features extracted: entropy={noise_features['lbp_entropy']:.2f}, "
    ...
    def test_wavelet_feature_extraction(self):
        ...
        # 必要な特徴量が含まれていることを確認
        required_features = ["wavelet_energy_h", "wavelet_energy_v", "wavelet_directionality"]
        ...
        print(
            f"Wavelet features extracted: h_energy={line_features['wavelet_energy_h']:.1f}, "
    ...
    def test_spatial_feature_extraction(self):
        ...
        print(
            f"Spatial features extracted: edge_density={grad_features['edge_density']:.3f}, "
        ...
        for key in features1.keys():
            if key in features2:
                self.assertAlmostEqual(
                    features1[key], features2[key], places=5, msg=f"Feature {key} inconsistent"
                )
...
class TestScreentonePatternClassifier(unittest.TestCase):
    ...
    def test_classifier_initialization(self):
        ...
        print(
            f"Classifier initialized with thresholds for {len(classifier.thresholds)} pattern types"
        )
...
class TestEnhancedScreentoneDetector(unittest.TestCase):
    ...
    def test_detector_initialization(self):
        ...
        print(
            f"Detector initialized with confidence threshold: {detector.detection_params['min_confidence']}"
        )
    ...
    def test_screentone_detection_dot_pattern(self):
        ...
        print(
            f"Dot pattern detected: confidence={result.confidence:.3f}, "
    ...
    def test_screentone_detection_line_pattern(self):
        ...
        self.assertIn(
            result.screentone_type, [ScreentoneType.LINE_PATTERN, ScreentoneType.DOT_PATTERN]
        )
        self.assertGreater(result.confidence, 0.5)

        print(
            f"Line image detected as: {result.screentone_type.value}, confidence={result.confidence:.3f}, "
    ...
    def test_no_screentone_detection(self):
        ...
        print(
            f"Plain image result: has_screentone={result.has_screentone}, "
    ...
    def test_color_image_detection(self):
        ...
        print(
            f"Color image processed: type={result.screentone_type.value}, "
    ...
    def test_roi_mask_detection(self):
        ...
        print(
            f"ROI detection: type={result.screentone_type.value}, "
            f"confidence={result.confidence:.3f}"
        )
...
class TestConvenienceFunction(unittest.TestCase):
    ...
    def test_convenience_function(self):
        ...
        try:
            ...
            self.assertIsInstance(result, ScreentoneDetectionResult)
            print(
                f"Convenience function test: type={result.screentone_type.value}, "
                f"confidence={result.confidence:.3f}"
            )
