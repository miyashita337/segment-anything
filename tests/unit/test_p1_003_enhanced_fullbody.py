...
class TestEnhancedFullBodyDetector(unittest.TestCase):
    ...
    def test_detector_initialization(self):
        ...
        self.assertAlmostEqual(
            weights_sum, 1.0, places=2, msg="Weights should sum to approximately 1.0"
        )
    ...
    def test_aspect_ratio_score_calculation(self):
        ...
        for height, width, expected_range in test_cases:
            with self.subTest(height=height, width=width):
                ...
                print(
                    f"Aspect ratio {aspect_ratio:.2f}: score={score:.3f} "
    ...
    def test_comparison_with_original(self):
        """従来手法との比較テスト"""
        # 同じマスクで従来手法と改良手法を比較
        mask_data = {"bbox": [100, 40, 100, 300], "area": 30000}  # アスペクト比3.0
