...
class TestResourceMonitor(unittest.TestCase):
    ...
    def setUp(self):
        """テスト前準備"""
        self.monitor = ResourceMonitor(monitoring_interval=0.1, history_size=10)  # 高速テスト用
    ...
    def test_get_current_status(
        self, mock_loadavg, mock_process_iter, mock_pids, mock_net, mock_disk, mock_memory, mock_cpu
    ):
        """現在状況取得テスト"""
        # モックデータ設定
