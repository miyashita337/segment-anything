...
class TestCreateCommandHandler(unittest.TestCase):
    ...
    def test_check_existing_workflow_exists(self):
        ...
        mock_status = {
            ...
            "can_proceed": True,
            "completed_steps": [
                {"step_id": "step1", "completed_at": "2025-01-06"}
            ],
            "pending_approvals": []
        }
    ...
    def test_check_existing_workflow_error(self):
        ...
        self.handler.workflow_controller.get_workflow_status.side_effect = Exception("Database Error")
    ...
    def test_create_workflow_state_success(self):
        ...
        # メソッドが正しく呼ばれたか確認
        self.handler.workflow_controller.create_tracker_workflow.assert_called_once_with("TRACKER-001")
        self.handler.workflow_controller.get_workflow_status.assert_called_once_with("TRACKER-001")
    ...
    def test_create_workflow_state_exception(self):
        ...
        self.handler.workflow_controller.create_tracker_workflow.side_effect = Exception("Database Connection Error")
