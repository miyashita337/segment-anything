...
class TestTaskRecordStatisticsIntegration:
    ...
    def test_task_record_with_statistics(self):
        ...
        task = TaskRecord(
            tracker_id="METRICS-CLEANUP-001", description="旧10指標システム削除テスト", statistics=stats
        )
    ...
    def test_task_record_auto_statistics_initialization(self):
        ...
        task = TaskRecord(tracker_id="TEST-001", description="自動初期化テスト")
...
def run_all_tests():
    ...
    tests = [
        ...
        (
            "TaskRecord統計付きsheets変換",
            test_task_integration.test_task_record_to_sheets_row_with_statistics,
        ),
        (
            "TaskRecord統計付きsheets復元",
            test_task_integration.test_task_record_from_sheets_row_with_statistics,
        ),
    ]
