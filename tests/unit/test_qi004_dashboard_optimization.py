...
class TestDashboardOptimizer(unittest.TestCase):
    ...
    def test_optimize_dashboard_performance(self):
        ...
        result = self.optimizer.optimize_dashboard_performance(self.test_images, self.temp_dir)
...
class TestQI004DashboardOptimizationSystem(unittest.TestCase):
    ...
    def test_run_complete_optimization(self, mock_dashboard_gen, mock_pushover):
        ...
        # モック設定
        mock_dashboard_gen.return_value.generate_standard_dashboard.return_value = Path(
            "test_dashboard.html"
        )
        ...
        dashboard_path.write_text(
            "<html><body><img src='/workspace/QI-004/extraction/test.jpg'></body></html>"
        )
        ...
        result = system.run_complete_optimization("QI-004", self.extraction_dir, self.temp_dir)
...
class TestQI004EntryPoint(unittest.TestCase):
    ...
    @patch(
        "features.evaluation.qi004_dashboard_optimization_system.QI004DashboardOptimizationSystem"
    )
    def test_create_qi004_optimized_dashboard_success(self, mock_system_class):
        ...
        result = create_qi004_optimized_dashboard("QI-004", self.extraction_dir, self.temp_dir)
