...
class TestQI002PartialExtractionIntegration:
    ...
    def test_qi002_partial_extraction_workflow(self):
        ...
        if any(cls is None for cls in [PartialExtractionDetector, ExtractionQualityAnalyzer, CompletenessValidator]):
        ...
        for i, test_image in enumerate(problematic_extractions):
            ...
            integrated_result = {
                ...
                'has_issues': detection_result.is_partial_extraction or quality_result.overall_quality_score < 0.6
            }
