...
import tempfile
import unittest
from features.extraction.commands.base_command import BaseExtractionCommand, ExtractionConfig
...
class TestExtractionConfig(unittest.TestCase):
    ...
    def test_default_values(self):
        ...
        config = ExtractionConfig(input_path="/test/input.jpg", output_path="/test/output.jpg")
...
class TestBaseExtractionCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = ExtractionConfig(input_path="/test/input.jpg", output_path="/test/output.jpg")
    ...
    def test_validate_config_file_exists(self):
        ...
        try:
            config = ExtractionConfig(input_path=tmp_path, output_path="/test/output.jpg")
    ...
    def test_validate_config_file_not_exists(self):
        ...
        config = ExtractionConfig(
            input_path="/nonexistent/file.jpg", output_path="/test/output.jpg"
        )
        command = ConcreteCommand(config)
...
class TestSingleProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = ExtractionConfig(
            input_path=self.input_path, output_path=self.output_path, verbose=True
        )
    ...
    def test_load_image_success(self, mock_image_open):
        ...
        with patch("numpy.array") as mock_array, patch("cv2.cvtColor") as mock_cvt:
    ...
    def test_load_image_file_not_exists(self):
        ...
        config = ExtractionConfig(input_path="/nonexistent/file.jpg", output_path=self.output_path)
...
class TestBatchProcessor(unittest.TestCase):
    ...
    def test_process_batch(self):
        ...
        with patch(
            "features.extraction.commands.batch_processor.StableBatchProcessor"
        ) as mock_stable:
