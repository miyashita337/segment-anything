...
class TestStatisticalValidator(unittest.TestCase):
    ...
    def test_equal_variance_check(self):
        ...
        p_value, is_equal = self.validator.validate_equal_variance(
            equal_var_a, equal_var_b
        )
    ...
    def test_multiple_group_comparison(self):
        ...
        # ベースライン比較
        results = self.validator.compare_multiple_groups(
            groups, baseline='group_a'
        )
    ...
    def test_alternative_hypotheses(self):
        ...
        result_less = self.validator.welch_t_test(
            self.group_a, self.group_b, alternative='less'
        )
