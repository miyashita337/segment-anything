...
from features.evaluation.utils.true_success_analyzer import (
    TrueSuccessAnalyzer,
    TrueVerificationResult,
)
from features.evaluation.utils.visual_verification_system import (
    VerificationResult,
    VisualVerificationSystem,
)
...
class TestTrueSuccessAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # サンプル人間ラベル
        self.human_labels = {
            "test_image_1": {"bbox": [95, 95, 205, 305], "character_description": "主人公キャラクター"},
            "test_image_2": {"bbox": [45, 45, 155, 255], "character_description": "サブキャラクター"},
        }
