...
from tools.queue.notification_bridge import PushoverNotifier, NotificationBridge
...
class TestNotificationBridgeINTG089(unittest.TestCase):
    ...
    def test_duplicate_suppression_logic(self, mock_time):
        ...
        # 記録
        bridge.notification_history[notification_hash] = {
            'last_sent': 1000.0,
            'count': 1
        }
