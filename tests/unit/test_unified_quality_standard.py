...
class TestQualityStandard:
    ...
    def test_quality_standard_creation(self):
        """品質基準作成テスト"""
        standard = QualityStandard(name="test_standard", version="1.0.0")
...
class TestUnifiedQualityStandardSystem:
    ...
    def test_calculate_unified_score(self, sample_quality_standard):
        ...
        score = system._calculate_unified_score(
            ab_rate, sci, pla, ple, success_rate, fill_ratio, compactness, coverage, dataset_name
        )
        ...
        expected_score = (
            ...
            + 0.85 * 0.15  # pla
            + 0.9 * 0.1  # ple
            + 0.85 * 0.04  # success_rate
            + 0.7 * 0.03  # fill_ratio
            + 0.8 * 0.03  # compactness  # coverage
    ...
    def test_determine_quality_level(self):
        ...
        test_cases = [(0.9, "EXCELLENT"), (0.75, "GOOD"), (0.55, "ACCEPTABLE"), (0.3, "POOR")]
