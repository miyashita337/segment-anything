...
# bump_version テスト
assert_eq "patch bump" "0.9.25" "$(bump_version "0.9.24" "patch")"
assert_eq "minor bump" "0.10.0" "$(bump_version "0.9.24" "minor")"
assert_eq "major bump" "1.0.0" "$(bump_version "0.9.24" "major")"
