...
class AutoPipeline:
    ...
    def run_anime_model_search(self) -> Dict[str, Any]:
        ...
        search_results = {"models_found": [], "best_model": None, "test_results": {}}
        ...
        if search_results["test_results"]:
            best_model = max(
                search_results["test_results"].items(), key=lambda x: x[1].get("fullbody_score", 0)
            )
    ...
    def _test_anime_model(self, model_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            test_results = {"model_path": model_path, "tests": []}
    ...
    def collect_output_paths(self) -> List[str]:
        ...
        # Phase 2テスト結果
        phase2_patterns = ["/tmp/phase2_test_*.jpg", "/tmp/test_*.jpg", "/tmp/pipeline_test/*.jpg"]
    ...
    def generate_final_report(self) -> Dict[str, Any]:
        ...
        report = {
            ...
            if self.pipeline_status["end_time"]
            else "Running",
            "output_images": {"count": len(output_paths), "paths": output_paths},
    ...
    def run_full_pipeline(self):
        ...
        try:
            ...
            batch_results = self.recovery_executor.execute_with_recovery(
                self.run_batch_processing, best_model
            )
